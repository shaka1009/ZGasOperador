  ...
  private void requestPermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA)) {
        Toast.makeText(
                zgas.operador.IA.CameraActivity.this,
 ...
 protected void setFragment() {
        ...
        if (useCamera2API) {
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    ...
                                    zgas.operador.IA.CameraActivity.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
          ...
          int facing = (useFacing == CameraCharacteristics.LENS_FACING_BACK) ?
            ...
            zgas.operador.IA.LegacyCameraConnectionFragment frag = new zgas.operador.IA.LegacyCameraConnectionFragment(this,
                    getLayoutId(),
